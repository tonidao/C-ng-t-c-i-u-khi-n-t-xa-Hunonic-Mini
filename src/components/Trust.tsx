        ...
        <div className="mt-16 bg-white p-8 rounded-3xl shadow-sm border border-gray-100 flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1">
            ...
            <div className="flex gap-4">
              <img src="https://picsum.photos/seed/cert1/100/100" alt="Cert 1" className="h-16 grayscale hover:grayscale-0 transition-all" referrerPolicy="no-referrer" />
              <img src="https://picsum.photos/seed/cert2/100/100" alt="Cert 2" className="h-16 grayscale hover:grayscale-0 transition-all" referrerPolicy="no-referrer" />
            </div>
          </div>
          <div className="flex-1">
            <img 
              src="https://picsum.photos/seed/factory/600/300" 
              alt="Factory" 
